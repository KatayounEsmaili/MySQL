SET @startdate = '2020-06-12 00:00:00' , @finishdate = '2021-06-12 00:00:00' ,@username = 'sadooni';
 ...
 select  subquery.prdcategory,floor(sum(subquery.productprice)) as productprice,floor(sum(subquery.productprice-subquery.totalprice)) as profitprice -- ,subquery.productid,subquery.type,prdcategory -- ,sum(q.productprice) as suminvoice 
 from
(
