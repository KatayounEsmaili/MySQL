SET @startdate = '2021-03-21 00:00:00' , @finishdate = '2022-01-21 00:00:00' ,@username='sadooni';
use vtigercrm600;
...
from
(
SELECT -- users1.id as smownerid1,users1.user_name,
...
(SELECT  -- users2.id as smownerid2, users2.user_name,
...
-- group by q2.smownerid2
)as subq2, -- on subq1.smownerid1=subq2.smownerid2
-- left outer join 
(
  select  FLOOR(sum(q3.total3))  as totalbalance-- ,q3.smownerid3,q3.user_name
  from (
SELECT -- crm4.smownerid  as smownerid3,
inv4.total as total3
-- ,users3.user_name-- ,modt.module,modt.changedon,inv.balance,modtdetail.postvalue,modtdetail.prevalue,modtdetail.fieldname-- max(modt.changedon)
