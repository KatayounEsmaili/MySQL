SET @startdate = '2021-03-21 00:00:00' , @finishdate = '2022-03-21 00:00:00' ,@username='Mohebbi';
use vtigercrm600;
...
left outer join 
(
  select  FLOOR(sum(q3.total3))  as totalbalance,q3.smownerid3,q3.user_name  from (
...
or ((
 ...
 left outer join 
(
  select  FLOOR(sum(q4.total4))  as total,q4.smownerid4,q4.user_name  from (
